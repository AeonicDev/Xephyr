...
public final class ItemStackFormat {
     ...
     * The map scaling.
     */
    public static final String MAP_SCALING = "map-scaling";
     ...
     * The firework power.
     */
    public static final String FIREWORK_POWER = "firework-power";

    /**
     * The item's stored enchants.
     */
